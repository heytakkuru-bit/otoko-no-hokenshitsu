...
import { PERSONALITY_TYPES } from '@/lib/onna/types';
    ...
    <main className="bg-[#0a0a0a] text-white">
      ...
      <section>
        ...
        <div className="px-8 pt-10 pb-20 text-center">
          <p
            className="text-[#FF6B9D] font-bold mb-4"
          ...
          <Link
            href="/onna/questions"
            className="inline-block bg-[#FF6B9D] text-white font-black px-10 py-4 rounded-full text-sm tracking-widest active:scale-95 transition-transform duration-150"
          >
            診断を受ける
          </Link>
      ...
      <section className="px-8 py-20 border-t border-white/5">
        <p
          className="text-[#FF6B9D] font-bold mb-8"
      ...
      <section className="px-5 pb-24 border-t border-white/5 pt-20">
        <p
          className="text-[#FF6B9D] font-bold mb-5 px-1"
          style={{ fontSize: '10px', letterSpacing: '0.4em' }}
        >
          16 TYPES
        </p>
        <h2 className="text-3xl font-black mb-3 px-1">君はどの女だ？</h2>
        ...
        <Link
          href="/onna/questions"
          className="block w-full border border-[#FF6B9D] text-[#FF6B9D] text-center font-black py-4 rounded-2xl text-sm tracking-widest active:bg-[#FF6B9D]/10 transition-colors duration-150"
        >
          診断スタート →
        </Link>
      </section>
      ...
      <section className="px-6 pb-24 border-t border-white/5 pt-20">
        ...
        >
          ...
          <h3 className="text-2xl font-black mb-2">16漢診断</h3>
