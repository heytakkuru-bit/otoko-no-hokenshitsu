      ...
      {(() => {
        ...
        return (
          <>
            {otokoTypes.length > 0 && (
              <div className="px-5 mb-4">
                ...
                <div className="space-y-2">
                  {otokoTypes.map((ct) => (
                    <div key={ct.slug} className="flex items-start gap-3 bg-[#1e2d3d] border border-[#c9a04e]/10 rounded-xl p-3">
            ...
            {onnaTypes.length > 0 && (
              <div className="px-5 mb-4">
                <p className="text-[#c9a04e]/70 text-xs font-bold tracking-widest mb-3">✨ 相性の良い女友達</p>
                <div className="space-y-2">
                  {onnaTypes.map((ct) => (
                    <div key={ct.slug} className="flex items-start gap-3 bg-[#1e2d3d] border border-[#c9a04e]/10 rounded-xl p-3">
