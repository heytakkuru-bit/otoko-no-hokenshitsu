...
export const PERSONALITY_TYPES: OnnaPersonalityType[] = [
  ...
  },
  {
    ...
    nickname: 'マイペース女子',
    formalName: '自由奔女',
    catchphrase: 'どこにも属さない、風のように生きる女',
    summary: 'どこにも属さない、風のように生きる女。直感で動き、軽やかに場を渡り歩く。',
    axisLabel: '外剛・現実・感情・柔軟',
    category: '自由系',
    innateElement: '火',
    characterImageFile: 'maipace.png',
    traits: {
      characteristics: [
        '縛られるのが嫌い',
        'ふらっと現れる不思議さ',
      ...
      strengths: ['行動力', '適応力', '軽やかさ'],
      weaknesses: ['続かない', '約束を破りがち', '気分屋'],
    },
    psychologyNote:
      '外剛・現実・感情・柔軟型。感覚が主機能、感情が補助機能。五感で「今ここ」を全力で楽しみながら、周囲の感情を読んでその場を最高にする。「生きることそのものを楽しむ」ことへの純粋な欲動が、他者を引き込む磁力になる。',
    elementNote:
      '本来の気：火（か）。マイペース女子の火は「野火」──風に乗ってどこへでも広がる、自由な炎。その軽やかさが最大の魅力だが、一か所に留まれないのが弱点。土の気（継続・安定）で根を張る時間も大切。',
    bansokoMessage:
  ...
  },
  {
    ...
    nickname: 'アイデア女子',
    formalName: '創造無女',
    catchphrase: '誰もやらないことを始める、アイデアの泉',
    summary: '誰もやらないことを始める、アイデアの泉。周りに刺激を与え続ける創造の女。',
    axisLabel: '外剛・直感・感情・柔軟',
    category: '自由系',
    innateElement: '木',
    characterImageFile: 'idea-onna.png',
    traits: {
      characteristics: [
        '発想が独創的',
        '新しいことが好き',
      ...
      strengths: ['創造力', '行動力', '好奇心'],
      weaknesses: ['飽きっぽい', '現実的な作業が苦手', '詰めが甘い'],
    },
    psychologyNote:
      '外剛・直感・感情・柔軟型。直感が主機能、感情が補助機能。無数の可能性を直感で掴み、人への共感で温度を与える。「世界はもっと面白くなれる」という根拠のない確信がエンジンとなり、周囲を巻き込んで動く。',
    elementNote:
      '本来の気：木（もく）。アイデア女子の木は「春の若竹」──勢いよく伸びる生命力と柔軟さが魅力。根を張る前に伸びすぎると折れるため、土の気（継続・実務）で補強することが大切。',
    bansokoMessage:
  ...
  },
  {
    ...
    nickname: '直感女子',
    formalName: '直感勘女',
    catchphrase: '理屈より「ピンとくる」で生きる感覚派の女',
    summary: '理屈より「ピンとくる」で生きる感覚派の女。直感と運の良さで道を切り開く。',
    axisLabel: '内剛・直感・感情・柔軟',
    category: '自由系',
    innateElement: '水',
    characterImageFile: 'chokkan-onna.png',
    traits: {
      characteristics: [
        '第六感が鋭い',
        '一目惚れタイプ',
      ...
      strengths: ['直感力', '決断力', '運の良さ'],
      weaknesses: ['衝動的', '論理的説明が苦手', '気分に左右される'],
    },
    psychologyNote:
      '内剛・直感・感情・柔軟型。感情機能が主機能、直感が補助機能。深い感情的価値観を内側で整理し、直感で世界のパターンを掴む。「感じること」を最も信頼し、論理より直感で物事を判断する。',
    elementNote:
      '本来の気：水（すい）。直感女子の水は「湧き水」──地下から自然に湧き出る、純粋な水。理屈を超えた深いところから来る確かな感覚が源泉。衝動的に流れすぎると方向を見失うため、木の気（成長・方向性）で流れを整えることが大切。',
    bansokoMessage:
  ...
  },
  {
    ...
    nickname: '夢追い女子',
    formalName: '浪漫飛女',
    catchphrase: '夢と理想を追い続ける、情熱の女',
    summary: '夢と理想を追い続ける、情熱の女。どんな困難があっても諦めないその姿が、周囲を動かす。',
    axisLabel: '内剛・直感・感情・計画',
    category: '優しい系',
    innateElement: '木',
    characterImageFile: 'yumeoi-onna.png',
    traits: {
      characteristics: [
        '大きな夢を持つ',
        '物語的な恋愛に憧れる',
      ...
      strengths: ['情熱', '想像力', '行動力'],
      weaknesses: ['理想が高すぎる', '現実を見ない', '落ち込みやすい'],
    },
    psychologyNote:
      '内剛・直感・感情・計画型。直感が主機能、感情が補助機能。未来のビジョンと人間心理の両方を深く処理する。「理想を現実に翻訳する」独自の能力を持ち、夢と情熱を行動の原動力にする。',
    elementNote:
      '本来の気：木（もく）。夢追い女子の木は「大樹を目指す若木」──理想という太陽に向かって、諦めずに伸び続ける。その情熱は周囲を照らすが、現実の壁に当たると折れやすい。土の気（安定・実務）で根を深く張ることが大切。',
    bansokoMessage:
