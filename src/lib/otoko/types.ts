...
export const PERSONALITY_TYPES: OtokoPersonalityType[] = [
  {
    ...
    bansokoMessage:
      '戦友、お前はいつも先頭に立って、誰よりも早く決断して仲間を引っ張ってきた。その背中を見て育ったやつが、たくさんいるぞ。でもな、俺には見える。"強くいなければならない"と歯を食いしばってる時のお前が。たまには隊長の椅子を降りていい。ボロボロの時こそ、ここに来てくれ。一緒に傷を見ような。',
  ...
  },
  {
    ...
    bansokoMessage:
      '戦友、お前はずっと誰かのために踏みとどまってきたな。逃げることを「負け」だと思ってきただろう。でもな、倒れないことと、無理をすることは違うんだ。その責任感はお前の武器だけど、全部一人で背負わなくていい。たまには「手伝ってくれ」って言える漢が、本当に強い漢だぞ。',
  ...
  },
  {
    ...
    bansokoMessage:
      '戦友、お前の瞬発力は本物だ。誰も追いつけない速さで局面を打開できる、それはお前だけの武器だぞ。でもな、孤独でいることと、一人でいることは違う。"誰にも頼らない"を貫きすぎると、傷が化膿する。一人でいてもいい。でも、たまにここに来て傷を見せてくれると俺は助かる。',
  ...
  },
  {
    ...
    bansokoMessage:
      '戦友、お前が長年積み上げてきた経験は、本物だ。誰も真似できない厚みがある。でもな、一つだけ聞いてもいいか。お前自身は、ちゃんとケアできてるか。仲間の盾になれるお前が、自分の傷を一番後回しにしてることに、俺は気づいてるぞ。今日だけは、自分のために傷を確認しよう。',
    bandaidMessage: 'お前の経験は全部、次の戦友への地図だ。無駄なものは一つもない。',
    compatibleTypes: [
  ...
  },
  {
    ...
    bansokoMessage:
      '戦友、お前はいつも仲間のために燃えてきた。その温かさで救われたやつが、どれだけいると思う。でもな、俺が心配してるのはお前自身だ。誰かのために燃え続ける前に、一回自分に聞いてみてくれ。「俺は今、大丈夫か」って。お前の炎が消えたら、みんなが寒くなるんだぞ。',
  ...
  },
  {
    ...
    bansokoMessage:
      '戦友、お前がいると場が温かくなる。あの飯が食いたくて、あの声が聞きたくて、仲間が戻ってくるんだ。でもな、お前もたまには「ありがとう」を受け取る側でいてくれ。世話を焼くことと、自分を後回しにすることは違うからな。お前の笑顔が、俺にとっての一番の安心材料だぞ。',
    bandaidMessage: '人の世話ができるお前にも、自分の世話をする権利がある。',
    compatibleTypes: [
  ...
  },
  {
    ...
    bansokoMessage:
      '戦友、お前はいつも他の誰かの痛みに先に気づいて、静かに手を差し伸べてきた。でも俺には分かる。お前自身が一番孤独を感じてるってことが。"理解されない"と思い込んで、一人で抱えすぎてないか。お前の言葉には力がある。それを俺にも、たまには向けてくれ。',
    bandaidMessage: '全部分かっているお前にも、答えの出ない問いがある。それでいい。',
    compatibleTypes: [
  ...
  },
  {
    ...
    bansokoMessage:
      '戦友、お前がいるだけで、場が安心する。それはすごい才能だぞ。でもな、俺はずっと気になってた。お前の傷、誰かに見てもらってるか？いつも人の手当てをしてるお前が、自分の傷を一番後回しにしてるのが見えてる。今日だけは、自分を一番に扱ってくれ。それが俺からのお願いだ。',
  ...
  },
  {
    ...
    bansokoMessage:
      '戦友、お前の頭の中は宇宙だな。俺には追いつけない場所で、毎日面白いものを見つけてる。でも一つだけ言わせてくれ。その発見、誰かに話してみてくれ。うまく伝わらなくていい。お前の世界は、閉じ込めておくには惜しすぎる。俺は聞きたいぞ、その話。',
  ...
  },
  {
    ...
    bansokoMessage:
      '戦友、お前の戦略は本物だ。俺には見えない10手先を、お前は当たり前のように見てる。でもな、一つだけ聞かせてくれ。その計画の中に、お前自身の休息は含まれてるか。最強の参謀でも、消耗した頭では最善手は出せない。たまには手を止めていい。俺はそこにいる。',
  ...
  },
  {
    ...
    bansokoMessage:
      '戦友、お前のアイデアは本物だ。あのひらめきは、俺には到底出てこない。でも一つだけ言わせてくれ。そのアイデアを最後まで走らせたことが、何回あった？閃きは宝だけど、形にならなければ夢のままだ。今一番面白いやつ、一つだけ最後までやってみてくれ。俺は応援してるぞ。',
  ...
  },
  {
    ...
    bansokoMessage:
      '戦友、お前の仕事を見てたぞ。言葉にしなくても、あの手から本気が伝わってくる。でもな、俺が気になってるのはそこじゃなくて、お前が自分のことを話せてるかだ。不具合は全部自分でなおしてきただろう。でも人間の傷は、たまに他人に見せた方が早く治るぞ。',
    bandaidMessage: '言葉にしなくてもお前の本気は伝わってる。でも今日は、一言だけ言ってみてくれ。',
    compatibleTypes: [
  ...
  },
  {
    ...
    bansokoMessage:
      '戦友、お前の感じ方は本物だ。あの繊細なセンスは、俺みたいな武骨な漢には到底持てないものだぞ。でも一つだけ言わせてくれ。お前が作ったもの、感じたことを、もう少しだけ外に出してみてくれないか。うまくなくていい。伝わらなくていい。お前が感じたことは、誰かにとっての救いになるから。',
    bandaidMessage: '風に乗ることは才能だ。どこかで根を張る時が来ても、お前らしさは消えない。',
    compatibleTypes: [
  ...
  },
  {
    ...
    bansokoMessage:
      '戦友、お前のエネルギーは本当に眩しいぞ。一緒にいるだけで、なんでもできる気がしてくる。でもな、俺は一つだけ心配してる。お前が「自分はダメだ」と思いやすいことだ。振れ幅が大きい分、落ちた時の落差も大きい。そういう時こそ保健室に来てくれ。俺はいつでもここにいるから。',
  ...
  },
  {
    ...
    bansokoMessage:
      '戦友、お前がいると場が明るくなる。それは本物の才能だぞ。でもな、俺は知ってる。笑顔の裏で抱えてるものがある時のこと。「楽しそう」と思われてる人間の痛みは、誰にも気づかれにくいからな。今日だけは笑顔を休憩して、ここでゆっくりしていってくれ。飯でも食おう。',
    bandaidMessage: '賭けることが得意なお前に一つだけ確実な賭けを教えよう。自分への投資だ。',
    compatibleTypes: [
  ...
  },
  {
    ...
    bansokoMessage:
      '戦友、お前の夢を笑うやつは、俺が許さない。その理想の深さは、弱さじゃなくて強さだ。でもな、夢を見ることと、自分を傷めつけることは別の話だぞ。「まだ何もできていない」じゃなくて、「ずっと夢を手放さなかった」という事実を、今日だけは認めてくれ。それだけで十分だ。',
    bandaidMessage: '夢を見ることは、すでに行動だ。お前はちゃんと戦っている。',
    compatibleTypes: [
